...
{
    [CustomPropertyDrawer(typeof(RoomPropertyName))]
    public class RoomPropertyNameDrawer : PropertyDrawer
    {
        [Serializable]
        ...
        public const string KEY_SIGNALS_FAVORITES = "gc:roomproperty-favorites";
            ...
            dropdown.AddManipulator(new MouseDropdownManipulator(context =>
            {
                ...
                if (favoriteSignals.Length == 0)
                {
                    context.menu.AppendAction(
                        "No favorite Room Property found", null, 
