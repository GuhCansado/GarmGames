...
namespace NinjutsuGames.Photon.Runtime
{
    ...
    [Title("On Photon Join Random Failed")]
    [Category("Photon/Matchmaking/On Join Random Failed")]
    [Description("Called when a previous OpJoinRandom call failed on the server.")]
    ...
    [Serializable]
    public class EventPhotonJoinRandomFailed : Event, IMatchmakingCallbacks
    {
